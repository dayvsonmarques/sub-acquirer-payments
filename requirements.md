...
Permita simular a geração de um PIX via uma subadquirente.
Simule o recebimento do webhook de confirmação do PIX.
Permita simular um saque via uma subadquirente.
Utilize uma estrutura de código que facilite a integração de novas subadquirentes no futuro.
🧱 Requisitos Técnicos
Banco de Dados
...
SubadqA	Ver documentação	https://0acdeaee-1729-4d55-80eb-d54a125e5e18.mock.pstmn.io
SubadqB	Ver documentação	https://ef8513c8-fd99-4081-8963-573cd135e133.mock.pstmn.io
Rotas disponíveis
...
Um repositório público (GitHub ou GitLab) com o código-fonte da aplicação Laravel.
Um README explicando:
Como executar o projeto
Estrutura e decisões técnicas adotadas
Scripts de migração do banco.
Exemplos de chamadas (via cURL, Postman ou Swagger).
